...
Les particularités des divers sites :
...
Sur la partie logs management, la hiérarchie est la suivante :
...
* relay-SP stocke les logs pendant un certain temps. Réplique sa base de données dans le relay-SD.
